...
weight_decay = 0 
momentum = None
loss_type = 'crossentropy_and_dice'     #'weighted_crossentropy'/'crossentropy'/'dice'/'dice_onlyfg'/'crossentropy_and_dice (alfa,beta)'/'tversky'/'focal_tversky' --> https://arxiv.org/pdf/2006.14822.pdf
alfa = 1     #1      
beta = 0.4   #1      
augment_batch = True
